...
The source code of this module is also maintained in [the main GitHub repository](https://github.com/yopichy/aspnetboilerplate/tree/dev/src) (Abp.Zero.* and Abp.ZeroCore.* projects).
